...
class acf_field_swatch extends acf_field
{
	...
	*/
	...
	function input_admin_enqueue_scripts()
	{
		...
		wp_register_script( 'acf-input-swatch', $this->settings['dir'] . 'js/input.js', array('acf-input'), $this->settings['1.0'] );
		wp_register_style( 'acf-input-swatch', $this->settings['dir'] . 'css/input.css', array('acf-input'), $this->settings['1.0'] );
